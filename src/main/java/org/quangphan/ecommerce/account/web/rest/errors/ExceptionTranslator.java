package org.quangphan.ecommerce.account.web.rest.errors;
...
import org.quangphan.ecommerce.account.service.UsernameAlreadyUsedException;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        org.quangphan.ecommerce.account.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        org.quangphan.ecommerce.account.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
