...
import org.quangphan.ecommerce.account.repository.AppRoleRepository;
import org.quangphan.ecommerce.account.service.AppRoleService;
...
/**
 * REST controller for managing {@link AppRole}.
 */
@RestController
@RequestMapping("/api")
