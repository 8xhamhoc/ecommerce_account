...
describe('TblRole Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tbl-role', component: TblRoleComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tblRoles?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to tblRoleService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTblRoleIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTblRoleIdentifier).toHaveBeenCalledWith(entity);
