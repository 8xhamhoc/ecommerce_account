...
import { EntityArrayResponseType, TblUserService } from '../service/tbl-user.service';
...
export class TblUserComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITblUser): number => this.tblUserService.getTblUserIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.tblUsers = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ITblUser[] | null): ITblUser[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.tblUserService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
