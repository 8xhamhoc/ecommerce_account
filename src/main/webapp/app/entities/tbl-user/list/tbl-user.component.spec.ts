...
describe('TblUser Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tbl-user', component: TblUserComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tblUsers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to tblUserService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTblUserIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTblUserIdentifier).toHaveBeenCalledWith(entity);
